...
// --- BGM・システム制御 ---
const BGM_LIST = ['assets/sounds/BGM.mp3', 'assets/sounds/BGM2.mp3', 'assets/sounds/BGM3.mp3'];
const bgm = new Audio();
bgm.loop = false;
bgm.volume = 0.4;
const seFireworkList = [
    new Audio('assets/sounds/firework.mp3'),
    new Audio('assets/sounds/firework_2.mp3'),
    new Audio('assets/sounds/firework_3.mp3')
];
const seThrow = new Audio('assets/sounds/Throw.mp3');
const seClear = new Audio('assets/sounds/Clear.mp3');
const seWadaiko1 = new Audio('assets/sounds/wadaiko1.mp3');
const seWadaiko2 = new Audio('assets/sounds/wadaiko2.mp3');
