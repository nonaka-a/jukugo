...
const STAGES = [
    { enemyCount: 4, obstacles: [] }, // STAGE 1
    { enemyCount: 6, obstacles: [{x: 3, y: 2}, {x: 4, y: 2}, {x: 3, y: 5}, {x: 4, y: 5}] }, // STAGE 2
    { enemyCount: 8, obstacles: [{x: 3, y: 3, hp: 2}, {x: 4, y: 3, hp: 2}, {x: 3, y: 4, hp: 2}, {x: 4, y: 4, hp: 2}] }, // STAGE 3
    { enemyCount: 8, obstacles: [{x: 0, y: 0, hp: 2}, {x: 7, y: 0, hp: 2}, {x: 0, y: 7, hp: 2}, {x: 7, y: 7, hp: 2}], movingEnemies: 2 }, // STAGE 4
